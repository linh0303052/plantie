...
//Reference: Youtube channel Aaviskar Infotech at https://www.youtube.com/watch?v=fiP2PVnHtRQ
public class CameraActivity extends AppCompatActivity {

    private static final int MY_REQUEST_CODE = 10;
    TextureView view_finder;
    //capture by camera button
    ImageButton imgCapture;
    //open gallery button
    ImageButton imgGallery;
    //store image paths of added plants
    ...
    private ActivityResultLauncher<Intent> mActivityResultLauncher = registerForActivityResult(
            ...
            new ActivityResultCallback<ActivityResult>() {
                @Override
                //when image(s) is returned
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        Intent data = result.getData();
                        //get multiple image from gallery
                        ...
                        } else if (data.getData() != null) { //get a single image from gallery
                    ...
                    //show interface for user to view and add plant
                    Intent intent = new Intent(CameraActivity.this, ShowPhotoActivity.class);
                    intent.putExtra("paths", paths);
                    //images are rotated differently in camera and gallery
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //start camera immediately, with capture button and gallery button
        startCamera();
    }
    ...
    public void startCamera() {
        ...
        imgCapture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //saev image to external storage
